...
rotor_mixing_plane_face_to_match,_ = find_face(blocks,block_id, indices,outer_faces)
...
rotor_face_to_match,_ = find_face(blocks,block_id, indices,outer_faces)
...
block_id = 9; indices = np.array([0,0,0,96,0,48],dtype=int) 
rotor_hub_to_match,indx = find_face(blocks,block_id, indices,outer_faces)
...
block_id = 8; indices = np.array([0,148,0,96,148,48],dtype=int) 
rotor_shroud_to_match,indx = find_face(blocks,block_id, indices,outer_faces)
rotor_shroud3, outer_faces = find_connected_face(blocks,rotor_shroud_to_match, outer_faces)
rotor_shroud3.append(rotor_shroud_to_match.to_dict())
...
rotor_outlet,_ = find_face(blocks,block_id, indices,outer_faces)
...
face_match_1,indx = find_face(blocks,5, np.array([0,0,0,4,148,0], dtype=int),outer_faces)
outer_faces.pop(indx)
face_match_2,indx = find_face(blocks,15, np.array([64,0,48,68,148,48], dtype=int),outer_faces)
outer_faces.pop(indx)
