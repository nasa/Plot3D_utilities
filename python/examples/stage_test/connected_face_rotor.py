...
block_id = 9; indices = np.array([0,148,0,96,148,48],dtype=int) 
rotor_shroud_to_match,indx = find_face(blocks,block_id, indices,outer_faces)
...
# block_id = 10; indices = np.array([0,148,0,96,148,48],dtype=int) 
# rotor_shroud_to_match,indx = find_face(blocks,block_id, indices,outer_faces)
...
# block_id = 17; indices = np.array([0,148,0,28,148,116],dtype=int) 
# rotor_shroud_to_match,indx = find_face(blocks,block_id, indices,outer_faces)
# rotor_shroud5, outer_faces = find_connected_face(blocks,rotor_shroud_to_match, outer_faces)
# rotor_shroud5.append(rotor_shroud_to_match.to_dict())
# rotor_shroud.extend(rotor_shroud5)
# outer_faces.pop(indx)
