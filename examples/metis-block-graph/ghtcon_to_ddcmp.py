...
def create_ddcmp(ght_conn:str,ddcmp_file:str='ddcmp.dat',nprocessors:int=3,pkl_file_blocksizes:Optional[str]=None):
    """_summary_

    Args:
        ght_conn (str): GlennHT Connectivity File
        ddcmp_file (str, optional): Name of the file to write to. Defaults to 'ddcmp.dat'.
        nprocessors (int, optional): Number of partitions. Defaults to 3.
...
if __name__=="__main__":
    create_ddcmp("examples/metis-block-graph/CMC9/conn.ght_conn",ddcmp_file='examples/metis-block-graph/CMC9/ddcmp.dat',nprocessors=5,pkl_file_blocksizes='examples/metis-block-graph/CMC9/CMC009_blocksizes.pickle')

    create_ddcmp("examples/metis-block-graph/EEE-Stator/conn.ght_conn",ddcmp_file='examples/metis-block-graph/EEE-Stator/ddcmp.dat',nprocessors=5,pkl_file_blocksizes='examples/metis-block-graph/EEE-Stator/Combust_diced_blocksizes.pickle')
